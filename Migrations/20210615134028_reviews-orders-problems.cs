...
{
    public partial class reviewsordersproblems : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartProductsUsers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteProductsUsers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartProductsUsers_UserId",
                table: "CartProductsUsers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteProductsUsers_UserId",
                table: "FavoriteProductsUsers",
                column: "UserId");
